...
import { setOnboardingComplete, setUserLanguage, setFirstLaunchComplete } from '@/utils/storage';
      ...
      >
        ...
        <View style={styles.welcomeSection}>
          ...
          <Text style={styles.welcomeSubtitle}>
            Let&apos;s personalize your experience by selecting your preferred language for translations.
          </Text>
        </View>
          ...
          <View style={styles.languageGrid}>
            {languages.map((language) => (
              <TouchableOpacity
                ...
                style={[
                  styles.languageCard,
                  selectedLanguage?.code === language.code && styles.selectedLanguageCard,
                ]}
              ...
              >
                ...
                <Text style={[
                  ...
                  selectedLanguage?.code === language.code && styles.selectedLanguageNative,
                ]}>
                  {language.nativeName}
                </Text>
